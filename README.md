...
توجه داشته باشید سرویس <a href="https://github.com/farhadmirzapour/RayganSms" target="_blank">RayganSms API</a>  به همراه این پکیج بصورت اتوماتیک بر روی پروژه شما نصب می شود.
    بنابراین چنانچه از قبل این پکیج بر روی پروژه شما نصب و تنظیمات مربوطه را انجام داده اید ، نیازی به اقدام دیگری نمی باشد، در غیر این صورت مطابق دستورالعمل مربوطه )تنظیمات username,password,...(  اقدام نمایید.
</div>
